...
}`,...(oe=(te=v.parameters)==null?void 0:te.docs)==null?void 0:oe.source}}};var ae,re,se;k.parameters={...k.parameters,docs:{...(ae=k.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(false);
    const onClose = useCallback(() => {
      setOpen(false);
...
}`,...(se=(re=k.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};var ue,le,ie;x.parameters={...x.parameters,docs:{...(ue=x.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(true);
    const onClose = useCallback(() => {
      setOpen(false);
...
}`,...(ie=(le=x.parameters)==null?void 0:le.docs)==null?void 0:ie.source}}};var ce,de,pe;B.parameters={...B.parameters,docs:{...(ce=B.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(true);
    const onClose = useCallback(() => {
      setOpen(false);
...
}`,...(pe=(de=B.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};var me,Ce,ye;E.parameters={...E.parameters,docs:{...(me=E.parameters)==null?void 0:me.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(true);
    const onClose = useCallback(() => {
      setOpen(false);
...
}`,...(ye=(Ce=E.parameters)==null?void 0:Ce.docs)==null?void 0:ye.source}}};const On=["Default","Secondary","Fullscreen","NoCloseButton","Customized","WithId","CustomHeader","WithHero","WithHeroAndFullScreen","StickyHeaderAndFooter","ReactNodeHeader","ReactNodeHeaderWithHero"];export{F as CustomHeader,h as Customized,y as Default,A as Fullscreen,g as NoCloseButton,B as ReactNodeHeader,E as ReactNodeHeaderWithHero,f as Secondary,x as StickyHeaderAndFooter,v as WithHero,k as WithHeroAndFullScreen,b as WithId,On as __namedExportsOrder,_n as default};
